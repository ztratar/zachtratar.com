...
Information and truth cease to matter — instead, only what we believe matters. And if they can get us to believe something that helps them, even if it's not true, so be it.

Although mass manipulation is a trend throughout all of history, it turns out that giving everyone smartphones and instant access to every other human _changes_ _everything_. Through Facebook and online media, disinformation now spreads to millions within minutes, is targeted to the specific people who will believe it, and evolves social groups to purge skeptics.
